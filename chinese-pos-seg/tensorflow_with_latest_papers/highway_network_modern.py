...
def highway(input_, output_size='same', num_layers = 2, bias = -2.0, activation = tf.nn.relu, scope = None, use_batch_timesteps = False, use_l2_loss = True, timestep = -1, use_kronecker_reparameterization=False):
